    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Editar Equipe: {{ $equipe->titulo }}</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.equipes.update', $equipe->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <div class="row">
                                    <input type="hidden" name="id_user" value="{{ $equipe->id_user }}">
                                    <div class="mb-3 col-lg-12">
                                        <label for="titulo" class="form-label">Titulo</label>
                                        <input class="form-control" type="text" id="titulo" name="titulo" value="{{ $equipe->titulo }}" placeholder="Titulo">
                                    </div>
                                
                                    <div class="mb-3 col-lg-12">
                                        <label for="slug" class="form-label">URL</label>
                                        <input class="form-control" type="text" id="slug" name="slug" value="{{ $equipe->slug }}" placeholder="URL">
                                    </div>
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <select id="exibir" name="exibir" class="selectize-drop-header" placeholder="Exibir no site">
                                            <option value="{{ $equipe->exibir }}">{{ $equipe->exibir }}</option>
                                    ...
                                    <div class="mb-3 col-lg-6">
                                        ...
                                        <input class="form-control" type="file" id="imagem" name="imagem"  value="{{ $equipe->imagem }}">
                                    </div>
                                
                                    <div class="mb-3 col-lg-12">
                                        <label for="descricao" class="form-label">Descrição</label>
                                        <textarea class="form-control" id="descricao" name="descricao" rows="3">{{ $equipe->descricao }}</textarea>
                                    </div>
                            ...
                            <div class="col-lg-3">
                                @if($equipe->imagem)
                                    <img src="{{ asset(url("storage/{$equipe->imagem}")) }}" class="img-fluid img-thumbnail" />
                                @else
                                    <div class="alert alert-warning" role="alert">
                                        <i class="mdi mdi-alert-outline me-2"></i>
                                        Não há imagem disponível para esta Equipe.
                                    </div>
                                @endif
                            </div>

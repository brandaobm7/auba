      ...
      <div class="modal-dialog modal-full-width">
          <div class="modal-content">
              <div class="modal-header">
                  <h4 class="modal-title" id="ModalCadastrarLabel">Cadastrar Notícia</h4>
              ...
              <div class="modal-body row">
                  ...
                  <div class="mb-3 col-lg-6">
                      ...
                      <input type="text" id="datetime-datepicker" id="created_at" name="created_at" class="form-control" placeholder="Date and Time" value="{{ \Carbon\Carbon::now() }}">
                  </div>
